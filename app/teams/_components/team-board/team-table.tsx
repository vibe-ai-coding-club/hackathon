                        ...
                        >
                          {others[idx] ? (
                            ...
                            <button
                              ...
                              className="inline-flex items-center gap-0.5 rounded-md border border-dashed border-accent/40 px-2 py-0.5 text-xs text-accent cursor-pointer transition-colors hover:bg-accent/5"
                            >
                              <svg
                                className="size-3"
                                viewBox="0 0 20 20"
