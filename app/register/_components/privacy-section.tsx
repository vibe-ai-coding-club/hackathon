  ...
  return (
    <>
      <div className="space-y-2">
        ...
        {errors.privacyConsent && <FormError>{errors.privacyConsent}</FormError>}
      </div>
            ...
            <div className="max-h-[60vh] space-y-4 overflow-y-auto typo-body3 text-gray-700">
              ...
              <div>
                ...
                <ul className="list-inside list-disc space-y-0.5">
                  <li>
                    <span className="font-medium">필수:</span> 이름, 이메일, 연락처(전화번호)
                  </li>
                  <li>
                    <span className="font-medium">필수:</span> 환불 계좌 정보(은행명, 계좌번호, 예금주)
                  </li>
                  <li>
                    <span className="font-medium">팀 참가 시:</span> 팀원 이름, 이메일, 연락처
                  </li>
                  <li>
                    <span className="font-medium">선택:</span> 참여 동기 및 문의 사항
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p>
                  수집된 개인정보는 <span className="font-semibold">대회 종료 후 즉시 파기</span>
                  합니다. 단, 환불 처리가 완료되지 않은 경우 환불 완료 시까지 보유합니다.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  개인정보 수집·이용에 대한 동의를 거부할 권리가 있습니다. 다만, 필수 항목에 대한 동의를 거부할 경우
                  참가 신청이 불가합니다.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  ...
                  <span className="font-semibold">딸깍톤 행사 홍보 및 아카이빙 목적</span>
                  으로 공식 웹사이트, SNS 등에 활용될 수 있습니다. 참가 신청 시 이에 동의한 것으로 간주하며, 촬영을
                  원하지 않을 경우 행사 당일 운영진에게 별도 요청하실 수 있습니다.
                </p>
              </div>
