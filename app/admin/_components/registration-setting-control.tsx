  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <button
        ...
        disabled={loading}
        className={`rounded-lg px-3 py-1 typo-btn4 text-white transition-colors disabled:opacity-50 cursor-pointer ${
          isClosed ? "bg-success hover:bg-green-600" : "bg-error hover:bg-red-600"
        }`}
      >
